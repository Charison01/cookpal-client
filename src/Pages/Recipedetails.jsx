            ...
            <div className="px-2 w-fit lg:w-2/5">
              <div>
                <p className="leading-loose hidden md:block">
                  ...
                  this hearty {recipe?.title} looks fabulous placed on the table
                  for everyone to dive into. This dish will leave you looking
                  for more. See details below on how you can prepare this
                  simple, affordable yet healthy dish!
                </p>
              </div>
