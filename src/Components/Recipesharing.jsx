...
const RecipeSharing = ({ recipe }) => {
  ...
  const shareOnTwitter = () => {
    const twitterUrl = `https://twitter.com/intent/tweet?url=${recipeUrl}`;
...
async function handleSharing() {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold my-2 text-center">Share Recipe</h1>
      <div className="flex items-center gap-2 tex-3xl">
        {/* Facebook */}
        <button onClick={shareOnFacebook} className="mx-4">
          <svg
        ...
        {/* Twitter */}
        <button onClick={shareOnTwitter} className="mx-4">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="30"
            height="30"
        ...
        {/* WhatsApp */}
        <button onClick={shareOnWhatsApp} className="mx-4">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            x="0px"
            y="0px"
        ...
        {/* Copy Link */}
        <button onClick={copyRecipeLink} className="mx-4">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="30"
            height="30"
