...
export default function SkeletonRecipeCard({ cards }) {
  return Array(cards)
    .fill(0)
    .map((item, i) => (
      <div
        key={i}
        className="xsm:pb-2 h-[300px] xsm:w-full md:w-full lg:w-80 card border shadow-lg bg-base-100 my-2 md:my-3 md:mr-5 relative">
        {/* Skeleton loading elements */}
        <div className="h-3/5 w-full rounded-lg skeleton"></div>
