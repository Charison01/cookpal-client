export default function Recipecard() {
  return (
    <div className="h-96 w-96 card p-4 border shadow-lg bg-base-100 my-3">
      <img
        alt="recipe"
        className="h-2/3 rounded-lg"
        src="https://masalabasics.com/wp-content/uploads/2021/02/Ugali-300x298.jpg"
      />
      <p className="text-sm mt-2 text-gray-500">Diary free</p>
      <div className="my-2 font-bold flex items-center justify-between">
